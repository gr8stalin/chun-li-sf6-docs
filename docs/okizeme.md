...
- Drive rush throw
- Drive rush 4HP will hit meaty and be enhanced by drive rush, which should leave you +7 on block. On hit, you'll only get 2MP or 2MK depending on range
...
If you don't have drive, you get a dash and maybe a few frames of walking, or maybe [4]6LP (light fireball) and walking to recover drive.

If you do have drive, you'll have to be aware of how they're rising. On backrise you can do dash -> drive rush 4HP. On hit this leaves you +11, so you can cancel into stance MK and sbk. On block you're +3 and the pushback of 4HP will put you out of range of throw, so you can opt to do 2MP xx fireball or nothing.

On quickrise you can do dash -> drive rush 5MP. At max (depending on your timing), you're +11 on regular hit, +15 at max on counterhit, and +8 on block. On hit you get 2HP and can go for either stance launch combo or stance xx sbk. On block you can try to:

- tick throw
- immediate 2MK to catch backwalkers
- stagger another 5MP and use that to set up future throws in that situation
- commit to 2HP xx stance lk xx fireball/sbk
...
- framekill with 5LP and immediately do 3HP for a meaty overhead that's +4 on hit (which yields a 5LP DRC combo)
